...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="80" y="385" font-family="Arial, Helvetica, sans-serif" font-size="30" fill="#b9905f">Independent paper equity research</text>
  <text x="80" y="520" font-family="Arial, Helvetica, sans-serif" font-size="26" fill="#c9d3da">Timestamped theses · benchmarked vs the S&amp;P 500 · losers stay published</text>
